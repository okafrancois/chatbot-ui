...
AS $$
DECLARE
  project_url TEXT := 'https://chat.okacode.com';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdqY3p2Z3ltcWRjcmZpenpnZ29jIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwOTY4NjQ4MCwiZXhwIjoyMDI1MjYyNDgwfQ.rIUXC6DsQl6JSh4Car6x8WcG6EdP-RL5qSExRLagFss'; -- full access needed for http request to storage
